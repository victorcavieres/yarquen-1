...
public class AnalyzedDatum extends BaseDatum {
	public static final String ARTICLES = fieldName(AnalyzedDatum.class,
			"articles");
	public static final Fields FIELDS;
	public static final String OUTLINKS = fieldName(AnalyzedDatum.class,
			"outlinks");
	public static final String PAGE_SCORE = fieldName(AnalyzedDatum.class,
			"pageScore");
	public static final String URL = fieldName(AnalyzedDatum.class, "url");

	static {
		FIELDS = new Fields(URL, PAGE_SCORE, ARTICLES, OUTLINKS);
	}
